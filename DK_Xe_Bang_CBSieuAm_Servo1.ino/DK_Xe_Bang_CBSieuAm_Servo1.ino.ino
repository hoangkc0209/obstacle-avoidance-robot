...
int pos = 0;    // biến để lưu trữ vị trí servo
...
void quaycbsangtrai()
{
  myservo.write(150);              // báo cho servo đi đến vị trí trong biến 'pos'
  delay(1000);
  dokhoangcach();
  myservo.write(90);              // báo cho servo đi đến vị trí trong biến 'pos'
}
void quaycbsangphai()
{
  myservo.write(30);              // báo cho servo đi đến vị trí trong biến 'pos'
  delay(1000);
  dokhoangcach();
  myservo.write(90);              // báo cho servo đi đến vị trí trong biến 'pos'
}
